...
import com.tool.chooser.UserChooser;
...
public class ReceivedPanel extends JPanel implements ActiveLoad {
    private Logger logger = LoggerFactory.getLogger(ReceivedPanel.class);
    ...
    public ReceivedPanel(PublishManager publishManager) {
        this.publishManager = publishManager;
        this.initComponents();
        this.initTable();
    }

    private void ownerChangeButtonActionPerformed(ActionEvent e) {
        this.showUserChooser(this.freezeCheckboxTable.getCheckedList());
    }

    private void showUserChooser(List<Map> dataList) {
        if (dataList.size() == 0) {
            JOptionPane.showMessageDialog(this, AppConfig.getString("message.selection.tansowner"), AppConfig.getString("tansowner"), 2);
        } else {
            new UserChooser(AppConfig.getString("tansowner"), this, dataList);
        }
    }
    ...
    private void initComponents() {
        ...
        this.downButton.setBackground(new Color(242, 242, 242));
        this.downButton.addActionListener((e) -> {
            this.downButtonActionPerformed(e);
        });
        ...
        this.viewButton.setBackground(new Color(242, 242, 242));
        this.viewButton.addActionListener((e) -> {
            this.viewButtonActionPerformed(e);
        });
        this.menuBar.add(this.viewButton);
        this.ownerChangeButton.setBackground(new Color(242, 242, 242));
        this.ownerChangeButton.addActionListener((e) -> {
            this.ownerChangeButtonActionPerformed(e);
        });
        this.menuBar.add(this.ownerChangeButton);
        ...
        this.downButton.setIcon(AppConfig.getImageIcon("iconActionDownload.png", "Download"));
        this.printButton.setIcon(AppConfig.getImageIcon("iconActionPrint.png", "Print"));
        this.viewButton.setIcon(AppConfig.getImageIcon("iconActionView.png", "View"));
    ...
    private PropertiesManager getActionPropertiesManager(int action) {
        ...
        if (action == 1) {
            ...
            properties.setBoolean("application.toolbar.show.utility.open", Boolean.TRUE);
            ...
            if (dataList.size() == 0) {
                ...
                FutureTask<String> future = new FutureTask(new Callable<String>() {
                    public String call() {
                        ...
                        try {
                            ReceivedPanel.this.process.start();
                            ...
                            ReceivedPanel.this.process.end();
                        }
    ...
    private void writeLogAndIncreaseCount(List<Map> dataList, int action) {
        ...
        try {
            ...
            while(itr.hasNext()) {
                Map rowMap = PublishManager.transToMap((JSONObject)itr.next());
    ...
    class MouseRightButtonPopupMenu extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            if (e.getButton() == 1) {
                ...
                if (clickCount == 2) {
                    ReceivedPanel.this.viewOrPrintMouseAction(2);
                }
                ...
                downItem.addActionListener((e12) -> {
                    ReceivedPanel.this.download(ReceivedPanel.this.getSelectRow());
                });
                ...
                printItem.addActionListener((e1) -> {
                    ReceivedPanel.this.viewOrPrintMouseAction(1);
                });
                ...
                JMenuItem chownerItem = new JMenuItem(AppConfig.getString("tansowner"));
                chownerItem.setIcon(AppConfig.getScaledImageIcon("iconActionTransferOwnership.png", 25, 25));
                chownerItem.addActionListener((e12) -> {
                    ReceivedPanel.this.showUserChooser(ReceivedPanel.this.getSelectRow());
                });
                popupMenu.add(chownerItem);
